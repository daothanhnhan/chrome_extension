...
//       }
//     };
//     xhttp.open("GET", "http://cmsver01.webmienphi.org.vn/gmail/gmail_next.php?num=0", true);
//     xhttp.send();
...
var xhttp = new XMLHttpRequest();
    ...
    xhttp.open("GET", "http://cmsver01.webmienphi.org.vn/keyword/all-keyword.php", true);
    xhttp.send();
...
var xhttp = new XMLHttpRequest();
  ...
  xhttp.open("GET", "http://cmsver01.webmienphi.org.vn/gmail/total.php", true);
  xhttp.send();
...
chrome.runtime.onMessage.addListener(
  function(request, sender, sendResponse) {
    ...
    //   }
    // };
    // xhttp.open("GET", "http://cmsver01.webmienphi.org.vn/gmail/gmail_next.php?num="+dem, true);
    // xhttp.send();
    ...
    if (link == 'https://www.google.co.uk/') {
      next++;
      console.log(next);
    }
...
function get_stt () {
  ...
  xhttp.open("GET", "http://cmsver01.webmienphi.org.vn/gmail/get_stt.php", true);
  xhttp.send();
}
...
function get_gmail (sott) {
  var xhttp = new XMLHttpRequest();
    ...
    xhttp.open("GET", "http://cmsver01.webmienphi.org.vn/gmail/gmail_next.php?num="+sott, true);
    xhttp.send();
}
...
function set_stt (sott) {
  var xhttp = new XMLHttpRequest();
    ...
    xhttp.open("GET", "http://cmsver01.webmienphi.org.vn/gmail/set_stt.php?stt="+sott, true);
    xhttp.send();
}
